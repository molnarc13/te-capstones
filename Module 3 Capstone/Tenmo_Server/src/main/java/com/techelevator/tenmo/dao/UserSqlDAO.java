...
public class UserSqlDAO implements UserDAO {
	...
	public String getUsernameById(long id) {
		...
		String sqlGetUserById = "SELECT username FROM users WHERE user_id = ?";
		SqlRowSet result = jdbcTemplate.queryForRowSet(sqlGetUserById, id);
	...
	public List<String> getUsernameAndId() {
        ...
        SqlRowSet results = jdbcTemplate.queryForRowSet(sql);
        while(results.next()) {
            String idAndUsername = results.getLong("user_id") + "," + results.getString("username");
            users.add(idAndUsername);
        }
        return users;
	}
